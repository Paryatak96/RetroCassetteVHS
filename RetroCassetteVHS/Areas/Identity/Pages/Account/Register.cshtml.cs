    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var addToRoleResult = await _userManager.AddToRoleAsync(user, Input.InvitationCode == "SPECIAL_ADMIN_CODE" ? "Admin" : "User");

                    if (!addToRoleResult.Succeeded)
                    {
                        // Obsłuż błędy związane z dodawaniem do roli
                    ...
                    _logger.LogInformation("User created a new account with password and wallet.");
